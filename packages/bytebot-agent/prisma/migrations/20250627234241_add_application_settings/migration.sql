...
CREATE TABLE "ApplicationSettings" (
    ...
    "allowedDomains" TEXT[],
    "applicationName" TEXT NOT NULL DEFAULT 'Bytebot',
...
-- AddForeignKey
ALTER TABLE "ApplicationSettings" ADD CONSTRAINT "ApplicationSettings_masterUserId_fkey" FOREIGN KEY ("masterUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
